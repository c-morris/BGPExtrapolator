...
bool test_send_all_announcements() {
    ...
    // Check to providers
    e.send_all_announcements(e.graph->ases->find(2)->second, true, false, false);
    ...
    // Check to peers
    e.send_all_announcements(e.graph->ases->find(2)->second, false, true, false);
    if (!(e.graph->ases->find(1)->second->incoming_announcements->size() == 1 &&
          e.graph->ases->find(2)->second->all_anns->size() == 1 &&
    ...
    // Check to customers
    e.send_all_announcements(e.graph->ases->find(2)->second, false, false, true);
    if (!(e.graph->ases->find(1)->second->incoming_announcements->size() == 1 &&
          e.graph->ases->find(2)->second->all_anns->size() == 1 &&
          e.graph->ases->find(3)->second->incoming_announcements->size() == 1 &&
          e.graph->ases->find(4)->second->all_anns->size() == 1 &&
