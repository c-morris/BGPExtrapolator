...
bool test_process_announcements(){
    ...
    if ((*ann1_search).priority != (uint64_t) 1 << 24) {
    ...
    if ((*ann1_search_2).priority != ((uint64_t) 2 << 24) + ((uint64_t) (255 - 10) << 8)) {
    ...
    if ((*ann1_search_3).priority != ((uint64_t) 2 << 24) + ((uint64_t) (255 - 10) << 8)) {
    ...
    if ((*ann1_search_4).priority != ((uint64_t) 2 << 24) + ((uint64_t) (255 - 1) << 8)) {
    ...
    if ((*ann2_search).priority != (uint64_t) 2 << 24) {
