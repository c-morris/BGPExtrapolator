...
bool test_give_ann_to_as_path() {
    ...
    if ((*as_3_search).priority != ((uint64_t) 1 << 40) + ((uint64_t) 253 << 16) && // see Priority.h for more info on this
        (*as_2_search).priority != ((uint64_t) 2 << 40) + ((uint64_t) 254 << 16) &&
        (*as_5_search).priority != ((uint64_t) 3 << 40) + ((uint64_t) 255 << 16)) {
    ...
    if ((*as_2_search_2).priority != ((uint64_t) 2 << 40) + ((uint64_t) 253 << 16)) {
...
bool test_give_ann_to_as_path_origin_only() {
    ...
    // Test announcement priority calculation
    if (e.graph->ases->find(5)->second->all_anns->find(p)->priority != ((uint64_t) 3 << 40) + ((uint64_t) 255 << 16)) {
        std::cerr << "Priority calculation failed." << std::endl;
        return false;
    }
...
bool test_propagate_up_no_multihomed() {
    ...
    if (e.graph->ases->find(5)->second->all_anns->find(p)->priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 10) << 16) ||
        e.graph->ases->find(2)->second->all_anns->find(p)->priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 11) << 16) ||
        e.graph->ases->find(6)->second->all_anns->find(p)->priority != ((uint64_t) 1 << 40) + ((uint64_t) (255 - 11) << 16) ||
        e.graph->ases->find(1)->second->all_anns->find(p)->priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 12) << 16) ||
        e.graph->ases->find(3)->second->all_anns->find(p)->priority != ((uint64_t) 1 << 40) + ((uint64_t) (255 - 12) << 16)) {
...
bool test_propagate_up() {
    ...
    // Check propagation priority calculation
    if ((*as_5_search).priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 10) << 16) &&
        (*as_2_search).priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 11) << 16) &&
        (*as_6_search).priority != ((uint64_t) 1 << 40) + ((uint64_t) (255 - 11) << 16) &&
        (*as_1_search).priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 12) << 16) &&
        (*as_3_search).priority != ((uint64_t) 1 << 40) + ((uint64_t) (255 - 12) << 16)) {
        std::cerr << "Propagted priority calculation failed." << std::endl;
        return false;
    }
    return true;
...
bool test_propagate_up_multihomed_standard() {
    ...
    if ((*as_3_search).priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 10) << 16)) {
        std::cerr << "Propagted priority calculation failed." << std::endl;
        return false;
    }
    return true;
...
bool test_propagate_up_multihomed_peer_mode() {
    ...
    if ((*as_3_search).priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 10) << 16) ||
        (*as_5_search).priority != ((uint64_t) 1 << 40) + ((uint64_t) (255 - 11) << 16)) {
        std::cerr << "Propagted priority calculation failed." << std::endl;
        return false;
    }
    return true;
...
bool test_propagate_down_no_multihomed() {
    ...
    if ((*as_2_search).priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 10) << 16) &&
        (*as_4_search).priority != ((uint64_t) (255 - 11) << 16) &&
        (*as_5_search).priority != ((uint64_t) (255 - 11) << 16)) {
        std::cerr << "Propagted priority calculation failed." << std::endl;
        return false;
    }
    return true;
...
bool test_propagate_down_no_multihomed2() {
    ...
    // if (e.graph->ases->find(1)->second->all_anns->find(p)->priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 10) << 16) ||
    //     e.graph->ases->find(2)->second->all_anns->find(p)->priority != ((uint64_t) (255 - 11) << 16) ||
    //     e.graph->ases->find(4)->second->all_anns->find(p)->priority != ((uint64_t) (255 - 12) << 16) ||
    //     e.graph->ases->find(5)->second->all_anns->find(p)->priority != ((uint64_t) (255 - 12) << 16)) {
...
bool test_propagate_down_multihomed_standard() {
    ...
    if (e.graph->ases->find(1)->second->all_anns->find(p)->priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 10) << 16) ||
        e.graph->ases->find(2)->second->all_anns->find(p)->priority != ((uint64_t) (255 - 11) << 16) ||
        e.graph->ases->find(4)->second->all_anns->find(p)->priority != ((uint64_t) (255 - 11) << 16) ||
        e.graph->ases->find(3)->second->all_anns->find(p)->priority != ((uint64_t) (255 - 12) << 16)) {
        std::cerr << "Propagted priority calculation failed." << std::endl;
        return false;
    }
    return true;
...
bool test_send_all_announcements() {
    ...
    if (e.graph->ases->find(4)->second->all_anns->find(p)->priority != ((uint64_t) 3 << 40) + ((uint64_t) 255 << 16) ||
        e.graph->ases->find(2)->second->all_anns->find(p)->priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 1) << 16) ||
        e.graph->ases->find(3)->second->all_anns->find(p)->priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 1) << 16)) {
...
bool test_send_all_announcements_no_multihomed() {
    ...
    // Check priority calculation
    if (e.graph->ases->find(2)->second->all_anns->find(p)->priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 1) << 16) ||
        e.graph->ases->find(1)->second->all_anns->find(p)->priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 2) << 16) ||
        e.graph->ases->find(3)->second->all_anns->find(p)->priority != ((uint64_t) 1 << 40) + ((uint64_t) (255 - 2) << 16) ||
        e.graph->ases->find(5)->second->all_anns->find(p)->priority != ((uint64_t) (255 - 2) << 16)) {
        std::cerr << "Send all announcement priority calculation failed." << std::endl;
        return false;
    }
...
bool test_send_all_announcements_multihomed_peer_mode2() {
    ...
    // Check priority calculation
    if (e.graph->ases->find(5)->second->all_anns->find(p)->priority != ((uint64_t) 3 << 40) + ((uint64_t) 255 << 16) ||
        e.graph->ases->find(6)->second->all_anns->find(p)->priority != ((uint64_t) 1 << 40) + ((uint64_t) (255 - 1) << 16)) {
...
bool test_prepending_priority_middle() {
    ...
    if (e.graph->ases->find(5)->second->all_anns->find(p)->priority != ((uint64_t) 3 << 40) + ((uint64_t) 255 << 16) ||
        e.graph->ases->find(2)->second->all_anns->find(p)->priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 1) << 16) ||
        e.graph->ases->find(3)->second->all_anns->find(p)->priority != ((uint64_t) 1 << 40) + ((uint64_t) (255 - 3) << 16)) {
...
bool test_prepending_priority_beginning() {
    ...
    if (e.graph->ases->find(5)->second->all_anns->find(p)->priority != ((uint64_t) 3 << 40) + ((uint64_t) 255 << 16) ||
        e.graph->ases->find(2)->second->all_anns->find(p)->priority != ((uint64_t) 2 << 40) + ((uint64_t) (255 - 2) << 16) ||
        e.graph->ases->find(3)->second->all_anns->find(p)->priority != ((uint64_t) 1 << 40) + ((uint64_t) (255 - 3) << 16)) {
