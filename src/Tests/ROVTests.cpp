...
bool test_rov_give_ann_to_as_path() {
    ...
    if (e.graph->ases->find(3)->second->all_anns->find(p)->priority != ((uint64_t) 1 << 40) + ((uint64_t) 253 << 16) ||
        e.graph->ases->find(2)->second->all_anns->find(p)->priority != ((uint64_t) 2 << 40) + ((uint64_t) 254 << 16) ||
        e.graph->ases->find(5)->second->all_anns->find(p)->priority != ((uint64_t) 3 << 40) + ((uint64_t) 255 << 16)) {
    ...
    if (e.graph->ases->find(2)->second->all_anns->find(p)->priority != ((uint64_t) 2 << 40) + ((uint64_t) 253 << 16)) {
