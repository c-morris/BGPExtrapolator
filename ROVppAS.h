...
#define ROVPPAS_TYPE_ROVPPBP_LITE 11    // ROVpp Lite 3 (Preventive Ann with Blackhole Ann)
#define ROVPPAS_TYPE_ROVPPBIS_LITE 9    // ROVpp Lite 2 (Blackhole Ann to Customers Only)
