...
struct NegativeAnnouncement: public Announcement {
    ...
    Announcement hijacked_ann;  // a copy of the hijacked annnouncement

    NegativeAnnouncement(uint32_t aorigin, uint32_t aprefix, uint32_t anetmask,
        uint32_t from_asn, std::set<Prefix<>> n_routed, Announcement bad_announcement)
     ...
     */
    NegativeAnnouncement(uint32_t aorigin, uint32_t aprefix, uint32_t anetmask,
        double pr, uint32_t from_asn, bool a_from_monitor, std::set<Prefix<>> n_routed, Announcement bad_announcement)
