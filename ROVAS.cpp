...
bool ROVAS::should_make_neg_announcement(Announcement &announcement) {
  // TODO: Implement
}

bool ROVAS::does_path_intersect(std::vector<uint32_t> p1, std::vector<uint32_t> p2) {
...
std::vector<uint32_t> ROVAS::get_as_path(Announcement &announcement) {
