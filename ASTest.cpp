...
bool test_process_announcement(){
    ...
    Announcement a1 = Announcement(111, p.addr, p.netmask, 222);
    Announcement a2 = Announcement(111, p.addr, p.netmask, 223);
    a1.priority = 199;
    a2.priority = 298;
    ...
    Announcement a3 = Announcement(111, p.addr, p.netmask, 224);
    a3.priority = 299;
